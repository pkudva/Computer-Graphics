...
class vtk441MapperPart3 : public vtk441Mapper
{
 public:
   ...
   virtual void RenderPiece(vtkRenderer *ren, vtkActor *act)
   {
	   ...
	   glTranslatef(-5, 0, -5);
	   glRotatef(45, 0, 1, 0);
	   glScalef(neckSize, neckSize, neckLength);
	   DrawCylinder();
	   glPopMatrix();
	   ...
	   Brown();
	   glPushMatrix();
	   glTranslatef(-12, 0, -7.5);
	   glScalef(bodyLength, bodyWidth, bodyWidth);
	   DrawSphere();
	   glPopMatrix();
